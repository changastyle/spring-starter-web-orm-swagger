...
{
    private static final String PERSISTENCE_UNIT_NAME = "emktPU";
    ...
    public static List findAllByJPQLLIMIT(String jpql,int begin, int end)
    {
        EntityManagerFactory factory;
        List lista = new ArrayList();
    ...
    public static Object get(Class clase , long id)
    {
        EntityManagerFactory factory;
        Object result;
    ...
    public static Object updateReturnObj(Object objConModificaciones)
    {
//        boolean modificado = false;
